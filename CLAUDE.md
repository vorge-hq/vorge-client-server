...
0. **P4 + P4.5 — building. O1–O5 ✅ + F2 ✅ + F-AI ✅ (2026-07-16). ⬅ NEXT: Opus O6 (anomaly detection server engine, AD-2+ — `/model opus`).** Binding playbook: `docs/plans/p4-execution-plan.md` (gates: F2 ✅ · F-AI ✅ · F3 after O8). After O6: O7 → O8 → **F3** → O9. DoD: `docs/test-specs.md` §P4 + §P4.5.
