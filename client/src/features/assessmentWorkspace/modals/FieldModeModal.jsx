    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-900/40 p-4 backdrop-blur-sm">
      <div className="flex max-h-[85vh] w-full max-w-xl flex-col overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-xl">
        ...
        <div className="flex-1 space-y-4 overflow-y-auto px-5 py-4 text-[13px]">
          ...
          <section>
            <h3 className="text-[12px] font-semibold text-zinc-700">Install as PWA</h3>
          ...
          <section>
            <h3 className="text-[12px] font-semibold text-zinc-700">What works offline</h3>
              ...
              {FEATURE_AVAILABILITY.map((feature) => (
                <li key={feature.id} className="flex items-center gap-2 text-[12px]">
                  {feature.available ? (
                    ...
                    <WifiOff size={13} className="shrink-0 text-zinc-400" />
                  )}
                  <span className={feature.available ? "text-zinc-800" : "text-zinc-500 line-through"}>
                    {feature.label}
                  </span>
                </li>
              ))}
          ...
          <section>
            <h3 className="text-[12px] font-semibold text-zinc-700">Sync queue</h3>
            <p className="mt-1 text-[11px] text-zinc-500">
            ...
            <div className="mt-2 inline-flex items-center gap-2 rounded-md border border-zinc-200 bg-zinc-50 px-3 py-2 text-[12px] text-zinc-700">
